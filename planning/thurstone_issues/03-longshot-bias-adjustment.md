...
**STATUS (2026-09-08): open.** An earlier note here marked this
unpublishable on racing grounds; that was an over-reading. Betting
markets are fine to write about. The proprietary line is the
syndicate's own data and findings, and this draft has none of that,
citing only the published calibration literature.
