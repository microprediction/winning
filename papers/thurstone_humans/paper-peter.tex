...
Like us, Rouder \cite{rouder2004} provides a summary view. Conditioning on a reduced choice set
is better than a guessing correction predicts and worse than the ratio rule predicts.

Wills, Reimers, Stewart, Suret and McLaren \cite{wills2000} reject the constant-ratio rule in
categorization and conclude that it should be replaced by a system based on Thurstonian choice,
very much in line with our overall impression. Their route to this was via a fitted
