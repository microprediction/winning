...
\title{\textbf{Softmax Masking Is a Choice Model:\\The Evidence For and Against Renormalizing Probabilities}}
\author{Peter Cotton}
...
Eight of the nine rows where linear normalization predicts better are one phenomenon. Four are
