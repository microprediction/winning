...
twelve of the twelve induced from rankings. The rows are clustered and the corpus was assembled
by search, so those counts describe it rather than estimating a rate.
\end{abstract}
