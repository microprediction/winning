...
probabilistic modelling, and implicit whenever a softmax is masked or a vector of
normalized weights has entries deleted and the remainder rescaled. But a
