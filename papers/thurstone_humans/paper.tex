...
random-utility models it is the model with Gumbel noise. That sufficiency is due to Holman
and Marley, originally through an unpublished proof reported by Luce and Suppes
\cite{lucesuppes1965} and later associated with their 1974 chapter \cite{holman1974};
Yellott \cite{yellott1977} added that pairwise comparisons alone do not identify the noise
law, and that Gumbel is unique once triples are included. Assume Gaussian noise
...
random-utility models, Gumbel errors generate Luce choice probabilities. That construction
is due to Holman and Marley, through an unpublished proof reported by Luce and Suppes
\cite{lucesuppes1965} and later associated with \cite{holman1974}; Yellott
\cite{yellott1977} showed it is not unique from pairwise comparisons but that Gumbel is
uniquely identified once triple comparisons are included. Which generative assumption to make is
...
A. A. J. Marley, with no title or date given.
