...
\begin{figure}[H]
\centering
\begin{tikzpicture}[x=1.62cm,y=0.42cm]
  \node[font=\scriptsize,anchor=east] at (-0.04,0) {line lengths, twelve to pairs};
  \draw[gray!35,thin] (0,0) -- (4.0,0);
  \fill (0.6,0) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-1) {occupational prestige};
  \draw[gray!35,thin] (0,-1) -- (4.0,-1);
  \draw[fill=white,thick] (0.85,-1) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-2) {GSS socialization};
  \draw[gray!35,thin] (0,-2) -- (4.0,-2);
  \draw[fill=white,thick] (0.88,-2) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-3) {GSS job values};
  \draw[gray!35,thin] (0,-3) -- (4.0,-3);
  \draw[fill=white,thick] (0.97,-3) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-4) {sports participation};
  \draw[gray!35,thin] (0,-4) -- (4.0,-4);
  \draw[fill=white,thick] (1.1,-4) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-5) {Jester file 3};
  \draw[gray!35,thin] (0,-5) -- (4.0,-5);
  \draw[fill=white,thick] (1.1,-5) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-6) {Jester file 1};
  \draw[gray!35,thin] (0,-6) -- (4.0,-6);
  \draw[fill=white,thick] (1.12,-6) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-7) {Jester file 2};
  \draw[gray!35,thin] (0,-7) -- (4.0,-7);
  \draw[fill=white,thick] (1.13,-7) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-8) {puzzles};
  \draw[gray!35,thin] (0,-8) -- (4.0,-8);
  \draw[fill=white,thick] (1.18,-8) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-9) {dots};
  \draw[gray!35,thin] (0,-9) -- (4.0,-9);
  \draw[fill=white,thick] (1.22,-9) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-10) {recognition foils};
  \draw[gray!35,thin] (0,-10) -- (4.0,-10);
  \fill (1.34,-10) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-11) {political goals};
  \draw[gray!35,thin] (0,-11) -- (4.0,-11);
  \draw[fill=white,thick] (2.35,-11) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-12) {symbol naming};
  \draw[gray!35,thin] (0,-12) -- (4.0,-12);
  \fill (2.92,-12) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-13) {colour naming};
  \draw[gray!35,thin] (0,-13) -- (4.0,-13);
  \fill (3.33,-13) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-14) {Wills categories};
  \draw[gray!35,thin] (0,-14) -- (4.0,-14);
  \fill (3.76,-14) circle (2.0pt);
  \draw[thick] (0,0.75) -- (0,-15.00);
  \draw[thick] (1,0.75) -- (1,-15.00);
  ...
  \draw[->] (-0.02,-15.00) -- (4.12,-15.00);
  \foreach \x in {0,0.5,1,1.5,2,2.5,3,3.5,4}
    {\draw ({\x},-15.00) -- ({\x},-15.16);
      \node[font=\scriptsize,anchor=north] at ({\x},-15.20) {\x};}
  \node[font=\scriptsize,anchor=north] at (2.0,-15.95) {$r$};
  \fill (4.0,-15) circle (2.0pt);
  \node[font=\scriptsize,anchor=east] at (-0.04,-15) {Netflix};
  \draw[gray!35,thin] (0,-15) -- (4.0,-15);
  \draw[->] (4.05,-15) -- (4.2,-15);
  \node[font=\scriptsize,anchor=west] at (4.22,-15) {$6.07$};
\end{tikzpicture}
...
Table~\ref{tab:favsecond} report. The one population on a perceptual continuum falls short of
it instead. Sixteen of the thirty-nine comparisons appear; the others restrict to sets of three or
more, so no pairwise $q_{ij}$ exists and no slope can be fitted, which excludes the tone
matrices, the Getty conditions and Townsend and Landon. Positions here do not reproduce
...
populations, the table scores forecasts. Netflix has three alternatives and three pairs.}
\label{fig:line}
\end{figure}
