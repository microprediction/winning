...
random-utility models it is the model with Gumbel noise; Holman and Marley established that
representation, and Yellott \cite{yellott1977} showed it is not identified from pairwise
...
representation due to Holman and Marley \cite{holman1974}; Yellott \cite{yellott1977} showed
...
renormalization is recovered exactly. That is the Holman--Marley representation \cite{holman1974}. The axiom is a boundary of the class.
...
In \emph{Psychophysical Judgment and Measurement}, chapter 7. Academic Press, 1974.
