...
random-utility models it is, by Yellott's theorem, the model with Gumbel noise. Assume Gaussian noise
...
renormalization is one such model rather than a consequence of probability theory. Within
the class of independent additive random-utility models, and for menus of at least three
alternatives, Yellott's theorem identifies it as the model with Gumbel noise; pairwise
choice alone does not pin the noise law down. Which generative assumption to make is
...
\cite{yellott1977}. The axiom is a boundary of the class.
...
vectors $\xi_\ell(\theta)$ are independent across $\ell$ with mean zero, covariance $I_K$
and finite second moments, and the individual chooses by \eqref{eq:condluce} at fixed
