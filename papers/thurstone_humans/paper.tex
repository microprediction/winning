...
sample, against a null in which the axiom holds exactly. We do so on thirty-three
...
Thirty-three comparisons are reported below, each one a population whose full-menu shares
...
\bottomrule
\end{tabular}
\caption{Twenty-three wins, five draws, five losses. The first block reads subset choice off a
...
\section{The rule's own founding dataset}
\label{sec:townsend}
