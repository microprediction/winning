...
resampling interval covers zero: Gaussian renormalization is then ahead in fourteen sources,
...
PrefLib perceptual & dots & $+.0016$ & $[+.0008, +.0026]$ & Gaussian \\
PrefLib perceptual & puzzles & $+.0009$ & pending & pending \\
Netflix & five files pooled\footnotemark[13] & $+.0018$ & pending & pending \\
...
Gaussian renormalization is ahead in fourteen sources, linear renormalization in one, one is
...
GSS socialization ($+0.0060$ to $+0.0055$) and sports participation ($+0.0056$ to $+0.0046$).
