...
\section{Why only two maps, and which way they differ}
\label{sec:maps}
...
\section{Restrictions that were observed}
\label{sec:observed}
...
\subsection{Consumer goods, all subsets of five}
\label{sec:menus}
...
\subsection{Colours and symbols, with the menu revealed after the stimulus}
\label{sec:after}
...
\subsection{Gambles, ballots, news slates and Wikipedia links}
\label{sec:more}
...
\section{Restrictions induced from rankings}
\label{sec:rankings}
...
\section{Letters and categories: the constant-ratio-rule datasets rescored}
\label{sec:townsend}
...
\section{How the difference is distributed}
\label{sec:distribution}

\subsection{By size of the surviving menu}
\label{sec:gainsize}
...
\subsection{By rank of the item chosen}
\label{sec:where}
...
\subsection{Probability that the favourite finishes second}
...
\section{Boundary conditions: where Gaussian renormalization loses}
\label{sec:boundary}
...
\appendix
\section{Gaussian taste heterogeneity as a mechanism}
\label{sec:mixture}
