...
\title{\textbf{Linear and Gaussian Renormalization\\of Choice Probabilities}\\[.45em]\large\normalfont Masking a softmax is the constant-ratio rule}
\author{Peter Cotton}
...
scoring the two against each other out of sample on thirty-nine population comparisons, old
and new. Twenty-four observe the smaller menu directly; twelve induce subset choice from
complete rankings. The contest wins where alternatives are distinct and unordered, and
