...
exactly produces at least the observed gain on the same menus; it tests departure from the rule
and not predictive superiority. Most rows use two hundred replicates and are floored at
$1/201$; the news row uses sixty, so its $.016$ is the floor $1/61$ rather than a measured
frequency, and the Wills row uses four hundred. The two
