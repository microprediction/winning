...
The gains in Tables~\ref{tab:menus} and~\ref{tab:heldout} are a few thousandths of a nat,
and that figure is hard to read on its own. Neither map is permitted to see a restricted
