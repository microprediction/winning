...
better than a guessing correction predicts and worse than the ratio rule predicts. Wills,
Reimers, Stewart, Suret and McLaren \cite{wills2000} test the ratio rule in categorization
and reject it.

So neither the question nor the answer's direction originates here, and this paper claims
neither. What has not been done, as far as we can establish, is the head-to-head: calibrate
