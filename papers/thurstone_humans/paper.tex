...
sample, against a null in which the axiom holds exactly. We do so on thirty
...
Thirty comparisons are reported below, each one a population whose full-menu shares
...
\bottomrule
\end{tabular}
\caption{Twenty-one wins, four draws, five losses. The first block reads subset choice off a
