...
whole vector of winning probabilities for fields far larger than any considered here; the
restricted predictions are then one-dimensional quadrature on the same grid. So the
