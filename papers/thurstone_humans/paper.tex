...
whole vector of winning probabilities at once. It scales far past anything needed here: in
the implementation used for this paper a field of $10^5$ calibrates in about a minute to an
accuracy of $8 \times 10^{-4}$, and $10^6$ winning probabilities evaluate in minutes, against
the ten alternatives of the largest collection in Table~\ref{tab:heldout}. The restricted
predictions are then one-dimensional quadrature on the same grid. So the
