...
\large a case for non-Gaussian noise in rating systems}
\author{Peter Cotton}
\date{\today}
...
outperforms TrueSkill \citep{herbrich2007}, Elo \citep{elo1978},
Glicko-2 \citep{glickman2012} and OpenSkill \citep{weng2011} over
1{,}158 races, and
...
parameter plus noise, and the noise is normal \citep{thurstone1927,
mosteller1951, herbrich2007} or logistic or Gumbel \citep{elo1978,
glickman1999, bradley1952, luce1959, plackett1975}. The convention is so uniform that it is
...
A control experiment confirms the block models retirement rather than
tails in general. Qualifying sessions are pace contests with almost no
retirement process, and rating them as contests in their own right
(1{,}158 sessions, same protocol) reverses the picture: forcing the 25\%
block onto qualifying damages rank correlation (Kendall's tau falls from
.609 to .564) and calibration (rank-PIT worsens from .025 to .088), while
the era-adaptive variant drives its own block mass down to $p = 0.03$ and
recovers both. Given a contest without the mechanism, the estimator
...
\bibitem[Bradley and Terry(1952)]{bradley1952} R.~A. Bradley,
M.~E. Terry. Rank analysis of incomplete block designs: I. The method
of paired comparisons. \emph{Biometrika} 39(3/4) (1952) 324--345.
\bibitem[Cotton(2021)]{cotton2021} P.~Cotton. Inferring relative
ability from winning probability in multientrant contests.
\emph{SIAM Journal on Financial Mathematics} 12(1) (2021) 295--317.
...
Behavior: A Theoretical Analysis}. Wiley, New York, 1959.
...
permutations. \emph{Journal of the Royal Statistical Society C} 24(2)
(1975) 193--202.
...
\bibitem[Weng and Lin(2011)]{weng2011} R.~C. Weng, C.-J. Lin. A
Bayesian approximation method for online ranking. \emph{Journal of
Machine Learning Research} 12 (2011) 267--300.
\end{thebibliography}
