...
% VERIFY: Torgerson quote (1958, pp.193-194) is agent-extracted; re-check against the book before submission.
...
truncated normals along a Cholesky factor. It is elegant, stochastic,
and resolved by draw count, and it prices one orthant per alternative,
exploiting nothing of the product shared across the $N$ winner events.
...
% VERIFY: slide quotes are agent-extracted; re-check before submission.
...
why. The inverse share map amplifies simulation and sampling error. In
the large-product asymptotics of Berry, Linton and Pakes, consistency
already constrains the draw count, and asymptotic normality requires
draws growing as the square of the number of products \citep{berry2004}.
Freyberger shows that unless the draw count grows quickly enough
relative to the sample, the surviving simulation error enters the
leading asymptotic terms as bias \citep{freyberger2015}. The standard
...
% VERIFY: Sawtooth quotes are agent-extracted from the primary PDFs; re-check before submission.
