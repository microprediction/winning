...
point estimate and report $1-(1-\hat p)^k$. We will call this the
plug-in. \citet{malladi2026} use it inside a coverage diagnostic,
...
\bibitem[V\'erine et~al.(2026)]{verine2026} A.~V\'erine et~al.
Estimating pass@$k$ from fewer samples with hierarchical Bayesian
priors. ICML 2026 workshop, OpenReview, 2026.
