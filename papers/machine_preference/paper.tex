...
\bottomrule
\end{tabular}
\caption{The discount on prior odds, split by what is being chosen. People exceed
the contest's prediction by a factor of $1.2$ on perceptual judgments and $1.3$ on
preferences. Machines exceed it by $5.8$. The axiom requires zero throughout.}
\label{tab:construct}
\end{table}

For people the classical dispute has a clear answer on this statistic. The
contest predicts $0.161$ for perceptual discrimination against an observed
$0.188$, and $0.317$ for preference against an observed $0.420$. Both are close,
both err in the same direction, and the axiom's zero is nowhere near either. A
century of argument about whether restricted choice renormalizes or re-races
comes down, in these domains, on the side of the race, with the true discount
somewhat larger than Case V allows.
