...
Two features of the breakdown carry more weight than the pooled figure.
First, \textbf{all 99 question types favor Thurstone} on average, not 90 or
95 of them. There is no category of question, among organs, colors, cities,
sports, instruments and the rest, in which renormalization is the better
account. Second, the deficit concentrates where the theory says it must:
deleting the model's favorite costs Luce $+0.407$, against $+0.114$ for
deleting a minor item. Removing the winner is precisely the case Harville
\cite{harville1973} mispriced, and it is precisely where the urn and the
contest diverge.
...
The honest summary is therefore narrower than the commercial panel invited.
Preference tuning is one route by which a model departs from renormalization,
demonstrably and substantially in some families, and the direction of the
