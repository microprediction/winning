...
The DPO ablation of \cite{cekinmez2026}, which cuts sense entropy from
$0.25$ to $0.18$ by preference tuning alone, points the same way. Testing
it requires log-probability access to a base and instruct pair, which the
models used here do not provide, and open-weight pairs are the natural
venue. Whether Thurstonian diagnostics
