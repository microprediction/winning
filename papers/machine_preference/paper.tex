...
modern models across thirteen designs and 48{,}536 cells scored by exact log
probabilities. Replaying the original two-slot stimuli over 2{,}183
...
sixteen open-weight models, alongside the masked language model study of the 2024 version and a
...
Base against instruct, local & 16 open & 3{,}219 & tuning effect in 4 of 6 pairs \\
\bottomrule
\end{tabular}
...
The architecture is constant along that ladder. All five models emit a
...
Softmax machines disobey Luce's Choice Axiom, which suggests that a
contest-structured output layer might generalize better than a softmax one.
