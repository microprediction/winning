...
Two of the designs deserve a caveat before the numbers. Adding a qualifier
changes the meaning of the question as well as the admissible set, and a
two-slot continuation conditions on a linguistic prefix, so collocation,
contrast and list convention all act alongside removal. Neither is a surgical
deletion from a fixed choice problem, and machine restriction is not a pure
urn problem in any case. The explicit exclusion phrasing is the closest thing
here to a choice-set intervention, and it is reported separately throughout
...
data. A referee will reasonably ask about one-parameter sharpening,
\begin{equation}
