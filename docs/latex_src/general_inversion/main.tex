...
Each row of the returned Jacobian now sums to zero because the quadrature
makes it so, not because the diagonal was set to force it. That residual
is therefore a measurement of the lattice's own quality: $7\times10^{-17}$
under the Gaussian base, $5\times10^{-11}$ under Gumbel.
...
The continuum form is exposed alongside the grid form. It is symmetric,
which the grid form is not, and that symmetry is what makes it useful as
a preconditioner.
