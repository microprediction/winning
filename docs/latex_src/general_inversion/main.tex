...
is two hundred times slower at $10^{4}$ draws with error above the
comparison's resolution. Forward
...
reach $6\times10^{-3}$ on the diagnostic draw. Stage (vi) of the
pipeline is what reaches this regime at all: the greedy
