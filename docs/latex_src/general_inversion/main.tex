...
variation. Scrambled-Sobol factor nodes, already provided for high factor
ranks, restore reference-level accuracy ($4\times10^{-4}$) at the same
call; heavy correlation wants quasi-Monte Carlo nodes, not deeper
polynomial rules.
