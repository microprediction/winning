...
every single-removal counterfactual in $O(nLQ)$ operations over a
lattice of $L$ winning values and $Q$ factor quadrature nodes, and
inverts observed probabilities back to utilities under a fixed, known
...
which matches central finite differences of the returned map with the grid held fixed at the base point and the normalization quotient
