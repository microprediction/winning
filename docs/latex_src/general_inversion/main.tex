...
\noindent At equal fitting time the simulated inversion pays a $63$ percent
error premium. The $R=1000$ figure is close to the exact one and the
difference is within replication noise at eight replications; the claim is
...
GHK's simulation noise had been regularizing by accident.
