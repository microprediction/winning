...
setup(
    ...
    packages=["winning", "winning.classic", "winning.factor", "winning.methods", "winning.bench", "winning.research", "winning.probit", "winning.ratings", "winning.ratings.verify", "winning.alternatives"],
    test_suite='pytest',
