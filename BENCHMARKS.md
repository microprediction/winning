...
Synthetic-world rankings are seed-stable: across five seeds (2,000-event
worlds) the log-loss ordering TrueSkill < Thurstone lattice < Glicko-2 < Elo <
OpenSkill PlackettLuce held in every run; across-seed sd (~0.03) is shared
world difficulty, not ranking noise.
...
| TrueSkill | 1.4793 | 0.6879 | 0.4431 | 0.5047 | 0.0072 | 0.0202 | 0.0630 | 5.9 |
| Thurstone lattice (winning) | 1.5225 | 0.7018 | 0.4291 | 0.4861 | 0.0093 | 0.0068 | 0.1314 | 11.5 |
| Glicko-2 | 1.5456 | 0.7092 | 0.4319 | 0.4851 | 0.0209 | 0.0143 | 0.1548 | 3.0 |
| Elo (multi-entrant) | 1.5499 | 0.7079 | 0.4403 | 0.4976 | 0.0271 | 0.0310 | 0.1498 | 0.4 |
| OpenSkill PlackettLuce | 1.7295 | 0.7783 | 0.4397 | 0.4987 | 0.0483 | 0.1753 | 0.2887 | 1.2 |
...
| TrueSkill | 1.3890 | 0.6545 | 0.4891 | 0.5311 | 0.0058 | 0.0116 | 0.1191 | 5.9 |
| Thurstone lattice (winning) | 1.4153 | 0.6640 | 0.4763 | 0.5268 | 0.0140 | 0.0088 | 0.1408 | 11.5 |
| Glicko-2 | 1.4442 | 0.6735 | 0.4788 | 0.5269 | 0.0260 | 0.0185 | 0.1724 | 2.9 |
| Elo (multi-entrant) | 1.4636 | 0.6759 | 0.4847 | 0.5333 | 0.0351 | 0.0335 | 0.1890 | 0.4 |
| OpenSkill PlackettLuce | 1.6972 | 0.7693 | 0.4816 | 0.5330 | 0.0570 | 0.1668 | 0.3354 | 1.2 |
...
| OpenSkill PlackettLuce (lattice predict) | 2.8243 | 0.8006 | 0.4825 | 0.5330 | 0.0736 | 0.1668 | 0.3470 | 3.2 |
...
| TrueSkill | 1.6952 | 0.7552 | 0.3750 | 0.4656 | 0.0144 | 0.0179 | 0.2125 | 5.9 |
...
| Thurstone lattice (winning) | 1.7717 | 0.7770 | 0.3456 | 0.4417 | 0.0081 | 0.0203 | 0.2677 | 11.6 |
| OpenSkill PlackettLuce | 1.8740 | 0.8111 | 0.3456 | 0.4514 | 0.0257 | 0.1794 | 0.3210 | 1.2 |
...
| OpenSkill PlackettLuce (lattice predict) | 4.5635 | 1.0318 | 0.3459 | 0.4514 | 0.1026 | 0.1794 | 0.4900 | 3.2 |
...
| Thurstone lattice (winning) | 0.5915 | 0.4054 | 0.6804 | 0.3608 | 0.0315 | - | - | 2.0 |
...
| Thurstone lattice (winning) | 0.5818 | 0.3978 | 0.6956 | 0.3928 | 0.0393 | - | - | 1.9 |
...
| Thurstone lattice (winning) | 0.6223 | 0.4323 | 0.6534 | 0.3069 | 0.0282 | - | - | 10.0 |
...
| OpenSkill PlackettLuce | 0.6869 | 0.4606 | 0.6493 | 0.2986 | 0.1068 | - | - | 0.7 |
...
| System | Log loss | Brier | Accuracy | Kendall tau | ECE | Rank-PIT KS | TV vs oracle | Seconds |
|---|---|---|---|---|---|---|---|---|
| Thurstone lattice (winning) | 0.6293 | 0.4389 | 0.6464 | 0.2929 | 0.0264 | - | - | 9.9 |
...
| OpenSkill PlackettLuce | 0.6835 | 0.4670 | 0.6401 | 0.2801 | 0.1019 | - | - | 0.7 |
...
| System | Log loss | Brier | Accuracy | Kendall tau | ECE | Rank-PIT KS | TV vs oracle | Seconds |
|---|---|---|---|---|---|---|---|---|
| Glicko-2 | 0.6675 | 0.4757 | 0.5691 | 0.1382 | 0.0182 | - | - | 1.2 |
| TrueSkill | 0.6698 | 0.4775 | 0.5735 | 0.1471 | 0.0210 | - | - | 7.0 |
...
| Thurstone lattice (winning) | 0.6733 | 0.4808 | 0.5685 | 0.1371 | 0.0426 | - | - | 36.0 |
...
| TrueSkill | 0.6185 | 0.4297 | 0.6537 | 0.3074 | 0.0141 | - | - | 7.9 |
| OpenSkill ThurstoneMostellerFull | 0.6212 | 0.4316 | 0.6517 | 0.3033 | 0.0293 | - | - | 2.7 |
| Thurstone lattice (winning) | 0.6218 | 0.4336 | 0.6473 | 0.2946 | 0.0057 | - | - | 39.3 |
| Glicko-2 | 0.6225 | 0.4336 | 0.6517 | 0.3035 | 0.0379 | - | - | 1.3 |
| Elo (multi-entrant) | 0.6363 | 0.4468 | 0.6284 | 0.2568 | 0.0107 | - | - | 0.4 |
| OpenSkill PlackettLuce | 0.6491 | 0.4461 | 0.6487 | 0.2974 | 0.0760 | - | - | 2.6 |
...
| System | Log loss | Brier | Accuracy | Kendall tau | ECE | Rank-PIT KS | TV vs oracle | Seconds |
|---|---|---|---|---|---|---|---|---|
| TrueSkill | 1.0923 | 0.5853 | 0.5333 | 0.3974 | 0.0073 | 0.0458 | - | 36.6 |
| Thurstone lattice (winning) | 1.1001 | 0.5879 | 0.5340 | 0.3955 | 0.0197 | 0.0453 | - | 62.4 |
| Glicko-2 | 1.1034 | 0.5895 | 0.5403 | 0.4049 | 0.0280 | 0.0486 | - | 17.9 |
| Elo (multi-entrant) | 1.1552 | 0.6087 | 0.5381 | 0.3853 | 0.0411 | 0.0569 | - | 2.5 |
| OpenSkill PlackettLuce | 1.1657 | 0.6130 | 0.5417 | 0.3930 | 0.0287 | 0.0969 | - | 6.7 |
| OpenSkill PlackettLuce (lattice predict) | 1.3035 | 0.6243 | 0.5396 | 0.3930 | 0.0710 | 0.0969 | - | 19.6 |
| Uniform baseline | 1.3850 | 0.7249 | 0.2751 | 0.0000 | 0.0000 | - | - | 0.2 |
| OpenSkill ThurstoneMostellerFull | 5.6504 | 0.7786 | 0.3887 | 0.1992 | 0.0892 | 0.3841 | - | 7.7 |

### Formula 1 1950-present (1158 grands prix; f1db, CC-BY-4.0; DNFs tied last)

| System | Log loss | Brier | Accuracy | Kendall tau | ECE | Rank-PIT KS | TV vs oracle | Seconds |
|---|---|---|---|---|---|---|---|---|
| Thurstone lattice (winning) | 2.2248 | 0.8281 | 0.3096 | 0.3300 | 0.0155 | 0.1781 | - | 12.4 |
| TrueSkill | 2.3461 | 0.8529 | 0.2751 | 0.2996 | 0.0109 | 0.1993 | - | 6.6 |
...
| Glicko-2 | 3.7272 | 0.9714 | 0.2708 | 0.2553 | 0.0216 | 0.1661 | - | 2.5 |
| OpenSkill PlackettLuce (lattice predict) | 4.4013 | 1.1397 | 0.2589 | 0.2828 | 0.0408 | 0.2220 | - | 2.4 |
...
| Glicko-2 | 2.3575 | 0.8936 | 0.1831 | 0.2527 | 0.0057 | 0.0166 | - | 6.5 |
| Thurstone lattice (winning) | 2.3926 | 0.8968 | 0.1675 | 0.2423 | 0.0108 | 0.0223 | - | 29.3 |
| TrueSkill | 2.4674 | 0.9088 | 0.1738 | 0.2065 | 0.0260 | 0.0365 | - | 13.7 |
| OpenSkill PlackettLuce | 2.4701 | 0.9120 | 0.0982 | 0.1767 | 0.0084 | 0.0686 | - | 3.0 |
...
- The lattice rater (this package) wins Formula 1 and WTA tennis outright,
  ties the leaders on ATP/EPL/Halo head-to-head, and is second only to
  TrueSkill on TrueSkill's own Halo free-for-all data and on the synthetic
  worlds that exactly match TrueSkill's generative assumptions.
