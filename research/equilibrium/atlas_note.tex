...
identical to six decimals ($0.995801$ both ways). The practical force:
the trace is the sum of the own-slopes the forward pass returns anyway,
so the whole-field collision rate is free with pricing.
