...
% file under the '.../Experiment 2/data/fitting results/extended'
% folder ('N' is the number of current fitting process). To avoid 
% overwriting, the line 43 is currently commented. To run this code, 
...
for subNum = 1:size(data.respPattern_cond1,1)
    ...
    [params(:,subNum), logL(subNum), modelFit{subNum}] = fitOneSub_extended(startingParams);
