...
% of items (colors). The number of items attneded is assigned 
...
% file under the '.../Experiment 1/data/fitting results/attention_extended'
% folder ('N' is the number of current fitting process). To avoid 
% overwritting the line 52 is currently commented. To run this code, 
...
data_sub.nItem = 2; % number of items attended
