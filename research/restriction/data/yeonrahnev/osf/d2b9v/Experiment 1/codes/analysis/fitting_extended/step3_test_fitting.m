...
% '.../Experiment 1/data/fitting results/modeling extended'.
% To avoid overwriting the line 139 is currently commented. 
...
modelToFit = 'population'; %'population', 'summary', 'twohighest'
