...
data <- read.csv2('data_experiment5.csv')
...
data %>%
  ...
  annotate('text', x=2, y=c(3950, 3750), label=c('2 alternatives','3 alternatives'),
...
data %>%
  ...
  annotate('text', x=1.4, y=c(0.6, 0.56), label=c('2 alternatives','3 alternatives'),
           col=c('darkgreen', 'orange'), size=9)
