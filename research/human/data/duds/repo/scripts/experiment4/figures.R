...
data <- read.csv2('data_experiment4.csv')
...
data %>%
  ...
  annotate('text', x=2, y=c(5000, 4500), label=c('2 alternatives','3 alternatives'),
...
data %>%
  ...
  theme_classic()+
  coord_cartesian(ylim=c(1300,3000))+
  annotate('text', x=4, y=c(1700, 1500), label=c('2 alternatives','3 alternatives'),
           col=c('darkgreen', 'orange'), size=9)
